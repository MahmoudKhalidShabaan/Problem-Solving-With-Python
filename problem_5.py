...
if((length_of_rectangle > 0) and (width_of_rectangle > 0)) :
    ...
    print("there is no area of the rectangle , because the length of the rectangle is = "+str(length_of_rectangle)+" , and width of the rectangle is = "+str(width_of_rectangle))