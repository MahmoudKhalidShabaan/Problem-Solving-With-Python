...
print("the age of the student is = "+str(student_total_marks))
if(student_total_marks >= 60) :
    ...
    print("SORRY \'"+student_name+"\' , you can not take addmission in the college , because the total marks of the student is = \'"+str(student_total_marks)+" makrs\' , because the total marks of the student is = \'"+str(student_total_marks)+" marks\' , and you need \'"+str(60 - student_total_marks)+" marks\' to take the addmission in the college")    