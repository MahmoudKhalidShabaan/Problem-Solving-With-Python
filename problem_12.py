...
# def check_student_take_addmission_in_college(stud_name , stud_marks) :
#     print("the name of the student is : \'"+stud_name+"\'")
#     print("the age of the student is : \'"+str(stud_marks)+" marks\'")
#     if(stud_marks >= 60) :
...
# check_student_take_addmission_in_college(student_name , student_total_marks)

def check_student_take_addmission_in_college(stud_name , stud_marks) :
    print("the name of the student is : \'"+stud_name+"\'")
    print("the total marks of the student is = \'"+str(stud_marks)+" marks\'")
    if(stud_marks >= 60) :
        return ("HI \'"+stud_name+"\' you can take addmission in the college , because the total marks of the student is : \'"+str(stud_marks)+" marks\'")
    else :
...
student_name = input("please enter the name of the student is : ")
student_total_marks = float(input("please enter the total marks of the student is = "))
student_addmission_college = check_student_take_addmission_in_college(student_name , student_total_marks)
print(student_addmission_college)