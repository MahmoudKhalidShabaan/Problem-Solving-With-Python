...
if(student_age >= 18) :
    ...
    print("SORRy \""+student_name+"! , Not OKAY , you can not take participation in the votting , because the age of the student is = \""+str(student_age)+" years\" , and you need \""+str(18 - student_age)+" years\" to be able to take participation in the votting")
